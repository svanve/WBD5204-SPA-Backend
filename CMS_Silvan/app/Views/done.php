            <div id="task-wrap" class="d-flex">    
                <main class="meine-aufgaben-main col-xs-12 col-lg-9 p-2">
                    <div id="list-container">
                        <h1 class="text-start m-2 p-2">Von mir erledigte Aufgaben</h1>
                        ...
                        <?php foreach($tasks as $task) : ?>
                            <div class="task-list-item w-88 list-line d-flex align-items-end justify-content-between" data-taskid="<?= $task[ "id" ] ?>">
                ...
                <aside id="detailbar" class="col-3 p-1 bg-light justify-content-center rounded d-flex position-fixed">
                    <!-- Content from done.js -->
                </aside>
            </div>
        </div>
        <script src="<?= $root ?>/js/done.js"></script>